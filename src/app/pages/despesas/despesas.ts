...
export class DespesasComponent implements OnInit {
  ...
  carregar() {
    this.loading = true;
    this.api.getLancamentos(this.mes, this.ano, 'Despesa').subscribe({
  ...
  nova() { this.editando = null; this.form = this.novoForm(); this.erro = ''; this.showModal = true; }
  ...
  salvar() {
    ...
    const body = { tipo: 'Despesa', ...this.form };
